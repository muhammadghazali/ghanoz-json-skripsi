...
\begin{flushright}
Bandung, \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
...
\begin{enumerate}
  ...
  \item Pak Abdulah Fajar, S.T. dan Djaja Achmad Sardjana, S.T., M.M. yang sudah memberikan masukan yang berharga pada saat sidang
...
Untuk merancang arsitektur teknis dari Web API, penulis menggunakan \textit{free-form diagram}. Model arsitektur teknis yang dibuat digambarkan pada papan tulis dan model tersebut dapat dilihat pada gambar \ref{arsitektur-teknis-web-api} yang ada di halaman selanjutnya.
...
% Rancangan Skema Representasi Resource
\section{Rancangan Skema Representasi Resource}

% Pertimbangan Rancangan Skema Representasi Resource dalam format JSON
\subsection{Pertimbangan Rancangan Skema Representasi Resource dalam format JSON}

% Rancangan Skema Representasi Resource Detail Event dalam format JSON
...
% Rancangan Skema Representasi Resource Daftar Event dalam format JSON
...
% Rancangan Skema Representasi Resource Detail Event dalam format XML
...
% Rancangan Skema Representasi Resource Daftar Event dalam format XML
...
\onehalfspacing Hasil akhir dari implementasi Web API adalah dua buah API, yaitu:

\begin{enumerate}
  \item \textit{Event Details API}. API ini digunakan untuk mengambil detail \textit{event} berdasarkan \textit{identifier}.
  \item \textit{Event List API}. API ini digunakan untuk mengambil daftar \textit{event}.
\end{enumerate}

Jika tertarik melihat bagaimana penulis berinteraksi dengan Web API menggunakan \textit{client} khusus untuk berinteraksi dengan Web API, silahkan untuk melihat video bernama "berinteraksi-dengan-web-api.mp4" yang disertakan bersama dengan laporan ini. Untuk memperlihatkan interaksi tersebut, penulis menggunakan aplikasi REST Console\footnote{https://chrome.google.com/webstore/detail/rest-console/cokgbflfommojglbmbpenpphppikmonn} yang merupakan \textit{Google Chrome extensions}.
...
Rasmusson, Jonathan. \emph{The Agile Samurai}. The Pragmatic Bookshelf, 2010. Buku elektronik.
...
Berikut detail \textit{response body} permintaan daftar \textit{event} yang dibalas oleh Web API:
  ...
  "data": [
    {
      ...
      "times": [
        {
          "milliseconds": 1613028781634,
          "fullFormat": "Thu Feb 11 2021 \n\
          14:33:01 GMT+0700 (WIT)",
          "year": 2021,
          "month": 1,
          "date": 11,
          "day": 1
    ...
    {
      "_id": 2,
      "title": "Dolor zzril exerci.",
      "shortDescription": "Lobortis \n\
      duis accumsan at vulputate.",
      "times": [
        {
          "milliseconds": 1613028781634,
          "fullFormat": "Thu Feb 11 2021\n\
      ...
      "isPassed": true,
      "rating": 4,
      "lastUpdated": 161292898164,
      "timestamp": 1612928781634
    },
    {
      "_id": 3,
      "title": "Accumsan hendrerit vel.",
      "shortDescription": "Vulputate\n\
        suscipit nibh nulla qui.",
      "times": [
        {
          "milliseconds": 1613028781634,
          "fullFormat": "Thu Feb 11 2021\n\
    ...
    // dan seterusnya sampai item ke-15
  ]
}
\end{lstlisting}

\subsection{Hasil Respon Permintaan Daftar Event dalam Format XML}
  ...
  <data>
    <data id="1">
      ...
      <shortDescription>Free
        event for students</shortDescription>
      <times>
        <time>
          <milliseconds>1613028781634</milliseconds>
          <fullFormat>Thu Feb 11 2021
            14:33:01 GMT+0700 (WIT)</fullFormat>
          <year>2021</year>
          <month>1</month>
          <date>11</date>
          <day>1</day>
    ...
    <data id="2">
      <title>Dolor zzril exerci.</title>
      <shortDescription>Lobortis
        duis accumsan at vulputate.</shortDescription>
      <times>
        <time>
          <milliseconds>1613028781634</milliseconds>
          <fullFormat>Thu Feb 11 2021 14:33:01
    ...
    <data id="3">
      <title>Accumsan hendrerit vel.</title>
      <shortDescription>Vulputate
        suscipit nibh nulla qui.</shortDescription>
      <times>
        <time>
          <milliseconds>1613028781634</milliseconds>
          <fullFormat>Thu Feb 11 2021 14:33:01
...
\chapter{Hasil Pengujian Web API} \label{lampiran:hasil-pengujian}

Berikut detail keluaran log hasil pengujian di level \textit{acceptance} yang dijalankan dengan perintah \textit{make test}\footnote{https://github.com/muhammadghazali/ghanoz-json/blob/master/Makefile}:
...
npm info shrinkwrap
  file "/home/ghazali/version-control/
  git/kuliah/skripsi/ghanoz-json/npm-shrinkwrap.json"
npm info preinstall ghanoz-json@0.3.5
npm info shrinkwrap
  file "/home/ghazali/version-control/
  git/kuliah/skripsi/ghanoz-json/npm-shrinkwrap.json"
npm info build
  /home/ghazali/version-control/
  git/kuliah/skripsi/ghanoz-json
npm info linkStuff ghanoz-json@0.3.5
npm info install ghanoz-json@0.3.5
npm info postinstall ghanoz-json@0.3.5
npm info prepublish ghanoz-json@0.3.5
npm info ok 
mongo ghanozjson_test --eval "db.dropDatabase()"
MongoDB shell version: 2.4.3
connecting to: ghanozjson_test
[object Object]
mongoimport --jsonArray
  --host localhost
  --db ghanozjson_test
  --collection events --file test/db/events.json
connected to: localhost
Thu May 23 09:17:33.533 check 9 150
Thu May 23 09:17:33.534 imported 150 objects
NODE_ENV=testing npm test

> ghanoz-json@0.3.5 test
  /home/ghazali/version-control/
  git/kuliah/skripsi/ghanoz-json
> node_modules/vows/bin/vows
  test/api-end-point-test/*-spec.js

Express server listening on port 3000
127.0.0.1 - - [Thu, 23 May 2013 02:17:34 GMT]
  "GET /event/1 HTTP/1.1" 200 356 "-" "-"
·· 127.0.0.1 - - [Thu, 23 May 2013 02:17:34 GMT]
  "GET /event/1 HTTP/1.1" 200 713 "-" "-"
127.0.0.1 - - [Thu, 23 May 2013 02:17:34 GMT]
  "GET /event/1 HTTP/1.1" 200 713 "-" "-"
·· 127.0.0.1 - - [Thu, 23 May 2013 02:17:34 GMT]
  "GET /event/1 HTTP/1.1" 406 49 "-" "-"
· 127.0.0.1 - - [Thu, 23 May 2013 02:17:34 GMT]
  "GET /events HTTP/1.1" 200 4722 "-" "-"
·· 127.0.0.1 - - [Thu, 23 May 2013 02:17:34 GMT]
  "GET /events HTTP/1.1" 200 10870 "-" "-"
127.0.0.1 - - [Thu, 23 May 2013 02:17:34 GMT]
  "GET /events HTTP/1.1" 200 10870 "-" "-"
·· 127.0.0.1 - - [Thu, 23 May 2013 02:17:34 GMT]
  "GET /events HTTP/1.1" 406 49 "-" "-"
·  
  ✓ OK » 10 honored (0.126s) 
  mongodump --db ghanozjson_test
connected to: 127.0.0.1
Thu May 23 09:17:34.254 DATABASE:
  ghanozjson_test to dump/ghanozjson_test
Thu May 23 09:17:34.255
  ghanozjson_test.system.indexes 
  to dump/ghanozjson_test/system.indexes.bson
Thu May 23 09:17:34.256 1 objects
Thu May 23 09:17:34.256
  ghanozjson_test.events
  to dump/ghanozjson_test/events.bson
Thu May 23 09:17:34.258 150 objects
Thu May 23 09:17:34.258 
  Metadata for ghanozjson_test.events
  to dump/ghanozjson_test/events.metadata.json
mongo ghanozjson_test --eval "db.dropDatabase()"
MongoDB shell version: 2.4.3
connecting to: ghanozjson_test
[object Object]
