...
\begin{enumerate}
  \item Web API sudah mampu untuk merespon permintaan daftar event dalam format JSON.
  \item Web API sudah mampu untuk merespon permintaan daftar event dalam format XML
  \item Web API sudah mampu untuk merespon permintaan konten detail event dalam format JSON
  \item Web API sudah mampu untuk merespon permintaan konten detail event dalam format XML
...
Masing-masing detail respon API tersebut dapat dilihat pada lampiran \ref{lampiran:detail-respon-web-api}.
