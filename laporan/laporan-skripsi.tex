...
\onehalfspacing RESTful Web API (juga disebut RESTful web service) adalah web API yang diimplementasikan dengan menggunakan HTTP dan prinsip-prinsip REST\footnote{Architectural Styles and
