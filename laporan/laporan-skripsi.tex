...
\addcontentsline{toc}{subsection}{Tujuan dan Manfaat Penelitian}
...
\addcontentsline{toc}{subsection}{Sistematika Penulisan}
...
\begin{description}
  ...
  \item[Bab III Analisis] Pada bagian ini akan dibahas hasil analisa terhadap masalah dan rancangan solusi yang diterapkan.
  \item[Bab IV Implementasi] Pada bagian ini akan dibahas hasil implementasi perangkat lunak sesuai dengan rancangan yang sudah ditentukan.
