...
Untuk merancang arsitektur teknis dari Web API, penulis menggunakan free-form diagram. Model arsitektur teknis yang dibuat digambarkan pada papan tulis dan model tersebut dapat dilihat pada gambar \ref{arsitektur-teknis-web-api}

\begin{figure}[htp]
\centering
\includegraphics[scale=1.00]{images/freeForm.JPG}
\caption{Model Arsitektur Teknis Web API dalam Free-form Diagram}
\label{arsitektur-teknis-web-api}
\end{figure}

Dikarenakan penulis menggunakan free-form diagram untuk merancang arsitektur teknis dari Web API, berikut adalah penjelasan detail dari beberapa bagian dari model di atas:
